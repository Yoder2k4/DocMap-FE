...
const DoctorDetailRegister = () => {
	...
	return (
		<div className="h-full w-[100vw] flex justify-center items-center py-2">
			<div className="bg-gray-800 h-full max-h-[40rem] w-1/2 mt-5 mb-6 rounded-xl flex flex-col">
				...
				<div className="px-8 py-5 h-[65vh] flex flex-col overflow-y-scroll no-scrollbar">
					...
					{editMenu === 'images' && (
					<Fragment>
						<UploadImage imgState={info.images.pfpInfo} imgType="pfpInfo" imageInfoChange={imgChangeHandler} />
						<UploadImage imgState={info.images.bgInfo} imgType="bgInfo" imageInfoChange={imgChangeHandler} />
					</Fragment>
				)}
...
export default DoctorDetailRegister;
